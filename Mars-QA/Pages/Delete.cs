...
namespace Mars_QA.Pages
{
    public class Delete : CommonDriver
    {
        ...
        public IWebElement delete=> dr.FindElement(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[2]/div/div[2]/div/table/tbody[1]/tr/td[3]/span[2]/i"));
